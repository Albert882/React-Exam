...
export default function PeripheryGiveCategoriesHeadPhone({ handleOpenPriceInterface, givePrice, handleOpenBrandInterface, giveBrand, uniqueFuncBrands, handleBrandsChange,  handleChangeMaxPrice, handleChangeMinPrice}) {
