...
export default function PeripheryGiveCategoriesAudioSpeaker({handleOpenSizeInterface,giveSize,sortRugsFromBrand,handleRugSort, handleOpenPriceInterface, givePrice, handleOpenBrandInterface, giveBrand, uniqueFuncBrands, handleBrandsChange, handleChangeMaxPrice, handleChangeMinPrice}) {
