...
export default function PeripheryGiveCategoriesKeyboard({handleOpenSizeInterface,giveSize,sortRugsFromBrand,handleRugSort, handleOpenPriceInterface, givePrice, handleOpenBrandInterface, giveBrand, handleBrandsChange, uniqueFuncBrands,  handleChangeMaxPrice, handleChangeMinPrice}) {

    const uniqueBrands = uniqueFuncBrands('Keyboard')
