...
export default function PeripheryGiveCategoriesWebcamera({handleOpenSizeInterface,giveSize,sortRugsFromBrand,handleRugSort, handleOpenPriceInterface, givePrice, handleOpenBrandInterface, giveBrand}) {
  return (
    <div className='win-h-screen h-auto bg-[#1a223f] flex flex-col gap-10 w-[23%] p-8'>
        ...
        <div className='w-full min-h-[64px] h-auto gap-5 bg-[#1d2645] rounded-xl flex flex-col p-5'>
            <div className='flex justify-between'>
                <span className='text-white text-lg font-medium'>Разрешение</span>
            ...
            <div className='flex justify-center gap-2 flex-col' style={{display: giveSize ? 'flex' : 'none'}}>
                <div className='flex gap-3'>
                    <input  type="checkbox" name="asus" className='bg-[#0F162F]' id="asus" />
                    <label htmlFor="" className='text-[#8190ca] font-medium'>1920x1080</label>
                </div>
                <div className='flex gap-3'>
                    <input  type="checkbox" name="blizzard"  className='bg-[#0F162F]' id="blizzard"/>
                    <label htmlFor="" className='text-[#8190ca] font-medium'>4096x2160</label>
                </div>
                <div className='flex gap-3'>
                    <input  type="checkbox" name="blizzard"  className='bg-[#0F162F]' id="blizzard"/>
                    <label htmlFor="" className='text-[#8190ca] font-medium'>640x480</label>
                </div>
            </div>
        </div>
    </div>
