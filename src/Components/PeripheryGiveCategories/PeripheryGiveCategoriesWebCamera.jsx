...
export default function PeripheryGiveCategoriesWebcamera({handleOpenSizeInterface,giveSize,sortRugsFromBrand,handleRugSort, handleOpenPriceInterface, givePrice, handleOpenBrandInterface, giveBrand, uniqueFuncBrands, handleBrandsChange, handleChangeMaxPrice, handleChangeMinPrice}) {

    const uniqueBrands = uniqueFuncBrands("WebCamera")

  return (
    <div className='win-h-screen h-auto bg-[#1a223f] hidden xl:flex flex-col gap-10 w-auto p-8'>
