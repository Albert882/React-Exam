...
export default function LogModal({
  ...
  return (
    ...
    >
      <div
        className="w-[400px] flex items-center flex-col gap-4 shadow-[0_0_45px_rgba(0,0,0,0.3)] mt-8 pt-5 text-white bg-[#293254] rounded-xl overflow-hidden"
      ...
      >
        <div className=" w-full flex items-center h-[30%] justify-between border-b border-[#34406a] pb-5 px-4">
          <div className="flex items-center gap-2">
            ...
            <p className=" text-xl font-semibold">Авторизация</p>
          </div>
        ...
        <div className=" w-full flex flex-col justify-center items-center gap-4">
          ...
          <div className=" w-full grid grid-cols-[1fr_2fr] gap-4 px-4">
            <div>
