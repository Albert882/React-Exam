...
export default function Footer() {
  return (
    <footer className="w-full h-[60vh] bg-[#141B35] flex items-center justify-center">
      <div className="flex w-full gap-8 h-full items-start  justify-center">
        ...
        <div className="flex flex-col gap-7 mt-[150px]">
